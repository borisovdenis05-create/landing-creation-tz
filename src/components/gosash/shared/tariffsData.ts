...
export const tariffs = [
  {
    ...
    name: "СТУДЕНТ",
    hours: 58,
    hoursLabel: "58 ч (МКПП) / 56 ч (АКПП)",
    theory: "Онлайн/офлайн формат",
    instructor: "Выбор филиала",
    features: [
      "KIA RIO (АКПП/МКПП)",
      "Выбор дня и времени занятий по теории",
      "Личный кабинет для онлайн-занятий",
      "Выбор времени по договорённости с инструктором",
      "Перенос занятий за 24 часа",
      "Мобильное приложение",
      "Сопровождение на всех этапах",
      "Менеджер-куратор",
      "Ученическая страховка включена в стоимость",
    ],
    extras: [] as string[],
    ...
    gsm: 8000,
    featured: false,
    badge: "СПЕЦПРЕДЛОЖЕНИЕ" as string | null,
    color: "",
  ...
  },
  {
    ...
    gsm: 8000,
    featured: false,
    badge: "СПЕЦПРЕДЛОЖЕНИЕ ОНЛАЙН" as string | null,
    color: "",
    installment: null as string | null,
    duration: null as string | null,
  },
  ...
  },
  {
    ...
    name: "ПРИОРИТЕТ",
    hours: 62,
    hoursLabel: "62 ч (МКПП) / 60 ч (АКПП)",
    theory: "Онлайн/офлайн формат",
    instructor: "Выбор филиала",
    features: [
      "KIA RIO (АКПП/МКПП)",
  ...
  },
  {
    ...
    name: "УГЛУБЛЕННАЯ",
    hours: 68,
    hoursLabel: "68 ч (МКПП) / 66 ч (АКПП)",
    theory: "Онлайн/офлайн формат",
    instructor: "Выбор филиала",
    features: [
      "KIA RIO (АКПП/МКПП)",
      "Выбор дня и времени занятий по теории",
      "Личный кабинет для онлайн-занятий",
      "Выбор времени в будние и выходные дни",
      "Перенос занятий за 24 часа",
  ...
  },
  {
    ...
    features: [
      ...
      "Перенос занятий за 24 часа",
      "Выбор инструктора",
      "Конструктор маршрута (+4 часа)",
      "Гарантийное занятие (6 часов)",
      "Мобильное приложение",
      "Сопровождение на всех этапах",
      "Менеджер-куратор",
      "ГСМ включён в стоимость",
      "Ученическая страховка включена в стоимость",
    ],
    extras: [] as string[],
    restrictions: [] as string[],
  ...
  },
  {
    ...
    name: "ВИП-программа",
    hours: 70,
    hoursLabel: "70 ч (МКПП) / 68 ч (АКПП)",
    theory: "Онлайн/офлайн формат",
    ...
    bonuses: [
      ...
      "Видеоурок «Как общаться с инспектором ГИБДД»",
      "Видеоурок «Скоростная магистраль»",
  ...
  },
  {
    ...
    name: "ЛЕДИ ДРАЙВ",
    hours: 72,
    hoursLabel: "72 ч вождения (МКПП) / 70 ч (АКПП)",
    theory: "Онлайн/офлайн формат",
    ...
    bonuses: [
      ...
      "4 видеоурока от психолога (как справиться со стрессом)",
      "Специальные подарки от партнёров: ТЭС сеть АЗС, ТИТО, ФИТНЕС ПАРК G1, DIMEGRY, ФОТОГРАФ ЧАЛАЯ",
    ],
    price: 84900,
    gsm: 0,
    featured: false,
